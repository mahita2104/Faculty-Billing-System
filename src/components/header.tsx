...
const Header: React.FC = () => {
  return (
    <header className="container-fluid">
      <div className="upperheadernav">
        <div className="container-fluid"></div>
      </div>
      <div className="row" style={{ margin: "0px", padding: "5px 0px" }}>
          ...
          <div className="row align-items-center">
            <div className="col-sm-7">
              <div className="heading">
                ...
                <div id="secondHeading">(Established by Govt. of Delhi vide Act 9 of 2012)</div>
                <div id="thirdHeading">ISO 9001:2015 Certified University</div>
              </div>
            </div>
            <div className="col-sm-5 d-flex justify-content-end">
              <a href="index.php" className="logo">
                <img src="https://d2lk14jtvqry1q.cloudfront.net/media/large_Department_of_Management_Studies_Indira_Gandhi_Delhi_Technical_University_for_Women_IGDTUW_Delhi_3792cc2387_41cda05cc3.png" alt="IGDTUW logo" height="100px" width="auto" />
              </a>
            </div>
          </div>
        </div>
